...
class AdrollBookmarks(unittest.TestCase):
    def setUp(self):
    ...
    def name(self):
        return "tap_tester_adroll_bookmarks"
    ...
    def get_credentials(self):
        return {
            'consumer_key': os.getenv('TAP_ADROLL_CONSUMER_KEY'),
            'consumer_secret': os.getenv('TAP_ADROLL_CONSUMER_SECRET'),
            'access_token': os.getenv('TAP_ADROLL_ACCESS_TOKEN'),
            'access_token_secret': os.getenv('TAP_ADROLL_ACCESS_TOKEN_SECRET'),
        }
